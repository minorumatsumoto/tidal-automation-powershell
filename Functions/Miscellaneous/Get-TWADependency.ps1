Function Get-TWADependency {
    <#
    .SYNOPSIS
    Get all Dependencies or specific dependency based on Type.

    .DESCRIPTION
    return dependency information based on input paramters

    .EXAMPLE
    Get-TWADependency -Type [ DependencyUnion | FileDependency | JESDependency | JobDependency | VariableDependency ]
    Get-TWADependency -Type FileDependency -DepID 47283, 47284, 47288
    Get-TWADependency -Type JobDependency -Search '*audit*' -Limit 1
    ...
    param (
        ...
        [ValidateSet("DependencyUnion","FileDependency","JESDependency","JobDependency","VariableDependency")]
        [string]$Type,
