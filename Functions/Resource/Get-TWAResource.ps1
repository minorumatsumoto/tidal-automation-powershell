Function Get-TWAResource {
    <#
    .SYNOPSIS
    Get information on Tidal resources.

    .DESCRIPTION
    return resource information based on input paramters

    .EXAMPLE
    Get-TWAResource -Type [ Resource | ResourceJobJoin | ResourceJobJoin2 | ResourceJobLocks | ResourceLock | ResourceNodeJoin | VirtualResource | InfoNodeJoin ] 
    Get-TWAResource -Type [ Resource | ResourceJobJoin | ResourceJobJoin2 | ResourceJobLocks | ResourceLock | ResourceNodeJoin | VirtualResource | InfoNodeJoin ] -ResourceID 20, 40, 1002 
    Get-TWAResource -Type [ Resource | ResourceJobJoin | ResourceJobJoin2 | ResourceJobLocks | ResourceLock | ResourceNodeJoin | VirtualResource | InfoNodeJoin ] -Search '*resource*' -Limit 3 
    ...
    param (
        ...
        [ValidateSet("Resource","ResourceJobJoin","ResourceJobJoin2","ResourceJobLocks","ResourceLock","ResourceNodeJoin","VirtualResource","InfoNodeJoin")]
        [string]$Type,
