Function Get-TWAJobRun {
    <#
    .SYNOPSIS
    Get all Job Run or specific Job Run information for given type.

    .DESCRIPTION
    return job run information based on input paramters

    .EXAMPLE
    Get-TWAJobRun -Type [ JobRun | JobRunGroup | QueuedJobRun | DataMoverJobRun | FTPJobRun | MPEJobRun | OS400JobRun | OSJobRun | OVMSBatchJobRun | OVMSCommandJobRun | OVMSJobRun | ServiceJobRun ]
    Get-TWAJobRun -Type JobRun -JobRunID 47283, 47284, 47288
    Get-TWAJobRun -Type DataMoverJobRun -Search '*audit*' -Limit 1
    ...
    param (
        ...
        [ValidateSet("JobRun","JobRunGroup","QueuedJobRun","DataMoverJobRun","FTPJobRun","MPEJobRun","OS400JobRun","OSJobRun","OVMSBatchJobRun","OVMSCommandJobRun","OVMSJobRun","ServiceJobRun")]
        [string]$Type,
